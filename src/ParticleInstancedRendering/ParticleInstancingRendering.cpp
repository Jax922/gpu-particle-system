...
ParticleInstancingRendering::ParticleInstancingRendering()
    : Application(1024, 1024, "Particle Rendering")
    , m_renderer(GetDevice())
{
}

void ParticleInstancingRendering::Initialize()
{
...
void ParticleInstancingRendering::Update()
{
    Application::Update();
...
void ParticleInstancingRendering::Render()
{
    Application::Render();
    ...
    glDrawArraysInstanced(GL_POINTS, 0, 1, m_particleSystem.GetParticleCount());
...
void ParticleInstancingRendering::Cleanup()
{
    m_imGui.Cleanup();
...
void ParticleInstancingRendering::InitializeCamera()
{
...
void ParticleInstancingRendering::InitializeMaterial()
{
...
void ParticleInstancingRendering::InitializeRenderer()
{
    m_renderer.AddRenderPass(std::make_unique<ForwardRenderPass>());
}

void ParticleInstancingRendering::InitializeModels()
{
...
void ParticleInstancingRendering::InitializeLights()
{
...
void ParticleInstancingRendering::RenderGUI()
{
    m_imGui.BeginFrame();
...
void ParticleInstancingRendering::RenderingModelWithParticles(const int& index)
{
